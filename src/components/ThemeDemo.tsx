    ...
    <div className="min-h-screen bg-minone-main transition-colors">
      ...
      <main className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <section className="minone-card p-6">
          ...
          <div className="space-y-4">
            <p className="text-gray-600">
              피그마 디자인을 기반으로 한 회원가입 모달을 확인해보세요.
            </p>
          ...
          <div className="space-y-4 max-w-2xl">
            ...
            <div className="minone-chat-ai max-w-md">
              ...
              <p className="text-gray-800">
                안녕하세요! 민원 접수를 도와드리겠습니다. 어떤 불편사항이나
                건의사항이 있으신지 자연스럽게 말씀해 주세요.
              </p>
            </div>
            ...
            <div className="flex justify-end">
              <div className="minone-chat-user max-w-md">
                <p>
                  윗집에서 새벽에 층간 소음이 너무 심해서 잠을 잘 수가 없어요
                </p>
              </div>
            </div>
            ...
            <div className="minone-chat-ai max-w-md">
              ...
              <p className="text-gray-800">
                층간 소음으로 불편하시군요. 정확한 처리를 위해 몇 가지 정보가 더
                필요합니다:
              </p>
        ...
        <section className="minone-card p-6">
          ...
          <div className="flex flex-wrap gap-2">
            <span className="minone-status-badge minone-status-received">
              접수완료
            </span>
            <span className="minone-status-badge minone-status-processing">
              처리중
            </span>
            <span className="minone-status-badge minone-status-completed">
              처리완료
            </span>
            <span className="minone-status-badge minone-status-urgent">
              긴급
            </span>
          </div>
        </section>
        ...
        <section className="minone-card p-6">
          ...
          <div className="text-sm space-y-1">
            <p>
              <strong>설정된 테마:</strong> {theme}
            </p>
            <p>
              <strong>적용된 테마:</strong> {resolvedTheme}
            </p>
            <p>
              <strong>폰트:</strong> Inter
            </p>
            <p>
              <strong>Border Radius:</strong> 0.5rem
            </p>
            <p>
              <strong>메인 배경:</strong> #f7faff
            </p>
            <p>
              <strong>헤더 배경:</strong> #f0f5fa
            </p>
          </div>
        </section>
      </main>
